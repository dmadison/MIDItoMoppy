/* 
 * HairlessBridge Example for MIDI-to-Moppy Library
 * by David Madison
 * 
 * Slight modification of the 'HardwareSerial' example to use the Hairless
 * MIDI to Serial bridge (http://projectgus.github.io/hairless-midiserial/).
 * You can use the custom baud rate settings with SoftwareSerial as well.
 * 
...
struct CustomBaud : public midi::DefaultSettings{
	static const long BaudRate = 115200; // Custom baud rate for Hairless
};
